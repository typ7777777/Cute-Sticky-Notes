...
***the qualify hacker verified in this project will get a ticket to use a full features .o binary**(still under development&lt;need one year or more maybe == the time that you figure out this app> by my e language: a OS.o almost without hardware code + 'close source IDE'.base.o) **for your custom OS**(the client to 'close source developer network: as a programer in homework@net' , if you don't want your hard work be stealed by chieves, and want earn more money to build your dream future IT world)*
